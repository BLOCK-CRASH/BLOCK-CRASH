...
CRePlayer::CRePlayer(CModel*model, CVector position, CVector rotation, CVector scale)
:CRePlayer()
{
	mpModel = model;
	mPosition = position;
...
void CRePlayer::Collision(CCollider*m, CCollider*y){}
