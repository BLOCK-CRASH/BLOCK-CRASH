...
//	mDelete.mMaterials[0].mDiffuse[3] = 0.0f;
	...
	new C3DMap(&mStage, CVector(0.0,151.0/*STAGE2の時だけ151*/,0.0), CVector(0.0,0.0,180.0), CVector(9.0, 9.0, 9.0));
	...
	new C3DPlayer(&m3DPlayer, CVector(0.0, 0.0, 0.0), CVector(0.0, 0.0, 180.0), CVector(0.65, 0.65, 0.65));
